...
//User Endpoints
app.put('/api/user/updateUsername', userCtrl.updateUsername )
app.put('/api/user/updatePassword', userCtrl.updatePassword )
app.put('/api/user/updateEmail', userCtrl.updateEmail )
